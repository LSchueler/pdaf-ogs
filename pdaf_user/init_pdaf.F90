...
! Local variables
  ...
  ! read the crucial analysis parameters from (hopefully) python generated namelist
  namelist /analysis/ delt_obs, rms_obs, forget

  open(12, file="pdaf.nml")
  read(12, nml = analysis)
